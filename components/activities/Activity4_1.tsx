...
export default function Activity4({
  ...
  // Clear feedback when entering Activity 4.4
  useEffect(() => {
    if (activity === 4.4) {
      setFeedback("");
    }
      ...
      <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl shadow-lg relative">
        ...
        <AnimatePresence>
          {feedback && (
            ...
            >
              <div className={`${feedback.includes('❌') ? 'bg-red-100 border-red-300 text-red-700' : 'bg-green-100 border-green-300 text-green-700'
      ...
      <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg relative">
        ...
        <div className="space-y-6 bg-white/80 rounded-xl p-6 shadow-sm">
          <div className="space-y-3">
            <p className="text-lg font-medium">1. <span className="font-bold text-blue-600">235</span> là số lẻ vì có chữ số tận cùng là...</p>
          ...
          <div className="space-y-3">
            <p className="text-lg font-medium">2. <span className="font-bold text-green-600">132</span> là số chẵn vì có chữ số tận cùng là...</p>
          ...
          <div className="space-y-3">
            <p className="text-lg font-medium">3. <span className="font-bold text-purple-600">326</span> là số...</p>
  ...
  // Hoạt động 4.4
  if (activity === 4.4) {
    // Khởi tạo dữ liệu mẫu nếu animalNumbers chưa được định nghĩa
    const initialAnimals = [
      { id: "1", number: 1, animal: "Chó" },
      { id: "2", number: 2, animal: "Mèo" },
      { id: "3", number: 3, animal: "Chim" },
      { id: "4", number: 4, animal: "Cá" },
      { id: "5", number: 6, animal: "Thỏ" },
      { id: "6", number: 7, animal: "Rùa" },
    ];

    // Đảm bảo animalNumbers có dữ liệu
    if (animalNumbers.length === 0) {
      setAnimalNumbers(initialAnimals);
    }

    // Tính tổng số con vật để hiển thị tiến độ chính xác
    const totalAnimals = initialAnimals.length;
    ...
    return (
      <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-teal-50 to-cyan-50 rounded-2xl shadow-lg relative">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-800 mb-3">
            🎯 Hoạt động 4.4: Phân loại động vật
          </h2>
          <p className="text-lg text-gray-600 bg-white/80 rounded-full px-6 py-2 inline-block shadow-sm">
            Kéo thả các con vật vào nhóm số chẵn hoặc số lẻ.
          </p>
        </motion.div>
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-sm font-medium text-teal-600">
              {classifiedCount}/{totalAnimals} con vật
            </span>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-3">
            <motion.div
              ...
              initial={{ width: 0 }}
              animate={{
                width: `${(classifiedCount / totalAnimals) * 100}%`,
              }}
              transition={{ duration: 0.5, ease: "easeOut" }}
            />
          </div>
